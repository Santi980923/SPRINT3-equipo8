            ...
            <div class="col-12">
              ...
              <div class="card">
                <div class="card-header d-flex p-0">
                  <h3 class="card-title p-3">Informacion</h3>
                  
                </div><!-- /.card-header -->
                <div class="card-body">
                   <center><h2 style="color:red">{{data}}</h2></center> 
                   <br>
                <center><a href="/"><button class="btn btn-primary">Regresar</button></a></center>
